...
const Main = () => {
  return (
   <div className="antialiased  text-gray-600 p-5">
            <div x-show="card">
  <div className="space-y-4">

    <div>
      <label className="block text-sm font-medium mb-1" htmlFor="card-nr">Username<span className="text-red-500">*</span></label>
      <input  id="card-nr" className="text-sm text-gray-800 bg-white border rounded leading-5 py-2 px-3 border-gray-200 hover:border-gray-300 focus:border-indigo-300 shadow-sm placeholder-gray-400 focus:ring-0 w-full" type="text" placeholder="Enter Username..." />
    </div>
  ...
  <div className="mt-6">
    ...
    <div className="text-xs text-gray-500 italic text-center">Reminder: You'll be Sacrificing 1:30:00 - 3:00:00 of your life</div>
    <div className="text-xs text-gray-500 italic text-center">Twss Count, Aman: 3.5k, Betsi: 244</div>
  </div>
</div>
    </div>
